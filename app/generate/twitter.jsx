    ...
    >
      ...
      <View style={styles.card}>
        <View style={styles.iconBox}>
          <Image source={require('../../assets/images/Vector.png')} style={{ width: 50, height: 50 }} />
        </View>
      ...
      {qrValue && (
        <View style={styles.qrWrapper}>
          ...
          <Text style={styles.qrText}>Scan to open Twitter</Text>
        </View>
      )}
     </View>
    </ImageBackground>
...
export default TwitterQRCodeScreen;
