...
const QRCodeWebsite = () => {
  ...
  const handleGenerateQRCode = () => {
    ...
    setQrValue(url);
    saveToHistory(url);
      navigation.navigate('openFile', { scannedData: url });
  };
    ...
    >
      ...
      <View style={styles.card}>
        ...
        <View style={styles.iconBox}>
          <Image source={require('../../assets/images/website.png')} style={{ width: 50, height: 50 }} />
        </View>
        ...
        {qrValue && (
          <View style={styles.qrWrapper}>
            ...
            <Text style={styles.qrText}>Scan to visit website</Text>
          </View>
        )}
      </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  backButton: { width: 40, height: 40, backgroundColor: '#2A2A2A', borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  title: { color: '#fff', fontSize: 22, fontWeight: 'bold' },
  card: { backgroundColor: '#2A2A2A', borderRadius: 10, padding: 20, paddingTop: 30, elevation: 8, borderTopWidth: 2, borderBottomWidth: 2, borderColor: '#F7A000' },
  iconBox: { alignItems: 'center', marginBottom: 20 },
  label: { color: '#ccc', fontSize: 14, marginBottom: 5 },
  input: { backgroundColor: '#1E1E1E', borderWidth: 1, borderColor: '#444', borderRadius: 8, padding: 10, color: '#fff', marginBottom: 20 },
  button: { width: '50%', alignSelf: 'center', backgroundColor: '#F7A000', paddingVertical: 12, borderRadius: 8, alignItems: 'center', marginBottom: 10 },
